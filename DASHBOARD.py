...
if LOGO_PATH.exists():
    ...
    _logo_tag = f'<img src="data:image/png;base64,{_logo_b64}" style="height:70px; width:auto; object-fit:contain; margin-right:14px; flex-shrink:0; mix-blend-mode: screen;">'
