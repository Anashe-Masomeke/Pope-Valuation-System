...
<style>
/* ==========================================
   FIX: Remove raw Material icon text fallback
   ========================================== */



/* Ensure SVG icons still show */
...
<style>
/* =========================================================
   HARD FIX: Hide Streamlit sidebar toggle TEXT fallback
   ========================================================= */

/* When sidebar is collapsed, Streamlit injects raw text
   like 'keyboard_double_arrow_right' inside the button.
   We hide the text but keep the button clickable. */
/* =========================================
   FINAL WORKING FIX
   ========================================= */

/* Hide all text inside collapsed button */
